...
'''
X, Y = SMOTE(random_state=4,sampling_strategy=0.01).fit_resample(x_train_normal,y_train[:,1])
...
# model.fit(x_train_normal,y_train[:,1],epochs=100,batch_size=1000)    SMOTE 적용 안했을 때
